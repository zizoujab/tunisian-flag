...
var filter_name = 'Rainbow';
var filter_name_system = 'rainbow';
...
var streamObj = {
	method: 'feed',
	name: 'I just put a Rainbow Filter on my profile picture!',
	link: 'http://rainbowfilter.io?ref=fbr',
	picture: 'http://rainbowfilter.io/images/big-heart-banner.png',
	caption: 'Rainbow Filter',
	description: "Use Rainbow Filter to filter and change your profile picture. You can even change the colors! Rainbow Filter for everyone! Rainbow Filters for everything!",
	action: {
		name: 'Filter',
		link: 'http://rainbowfilter.io?ref=fbr'
	}
					...
					function (response) {
						...
						FB.api(
							...
							function(response) {
								...
								for (var i = 0, l = response.data.length; i<l; i++){
									var album = response.data[i];
									if (album.type == 'profile' || album.type == 'cover')
									FB.api(
											'/' + album.id + '/photos/',
